...
name = 'Datos_senamhi_ayacucho_pauza_NaN.xlsx'
#https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.read_excel.html
#df = pd.read_excel(name, 'Hoja1', index_col=0)
df = pd.read_excel(name, na_values=-99.9)  # La primera columna no es el indice
print(df)
# El formato es:
...
xls = pd.ExcelWriter('Datos_agrupados_pauza_acum_NaN.xlsx')
